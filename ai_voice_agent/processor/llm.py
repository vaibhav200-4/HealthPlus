# ai_voice_agent/processor/llm.py
import os
import re
import json
...
class GroqLLM:
    ...
    async def extract_intent(self, text: str, state: dict) -> dict:
        ...
        spec_list_str = ", ".join(specs) if specs else "Cardiology, Dermatology, General Medicine, Gynecology, Neurology, Orthopedics, Pediatrics"
        ...
        system_prompt = (
            ...
            "- Handle STT phonetic mishearings or typos for medical specialties: e.g., 'cardio movies', 'cardio logistics', 'bookend cardiologist', 'cardio' -> specialization='Cardiology'; 'derma' -> specialization='Dermatology'; 'ortho' -> specialization='Orthopedics'. Map them to the closest standard specialization.\n"
